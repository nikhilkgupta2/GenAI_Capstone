      ...
      >
        <div className="flex min-w-0 flex-1 flex-col">
          <div className="flex h-14 items-center justify-between border-b border-slate-200 px-4 dark:border-white/10">
            <Link
              to="/"
              className="flex min-w-0 cursor-pointer items-center gap-3 rounded-md transition hover:scale-[1.02] hover:opacity-85 focus:outline-none focus:ring-2 focus:ring-slate-300"
              aria-label="IMS landing page"
              onClick={onCloseMobile}
            >
                      ...
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          cn(
                            ...
                            item.to === '/upgrade' &&
                            'border border-indigo-100 bg-indigo-50/50 text-indigo-600 shadow-sm hover:border-indigo-200 hover:bg-indigo-100 hover:text-indigo-700 dark:border-transparent dark:bg-gradient-to-r dark:from-indigo-500/10 dark:via-purple-500/5 dark:to-transparent dark:text-indigo-200 dark:shadow-[0_0_0_1px_rgba(99,102,241,0.25)] dark:hover:border-indigo-500/30 dark:hover:text-indigo-100',

  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
      <LandingContainer className="flex h-16 items-center justify-between">
        <Link to="/" className="flex cursor-pointer items-center gap-3 transition hover:scale-[1.02] hover:opacity-85" aria-label="IMS home">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          {isAuthenticated ? (
            <LandingButton
              to="/dashboard"
              variant="primary"
              className="h-11 rounded-xl bg-slate-950 shadow-lg shadow-slate-900/20 hover:bg-slate-800"
            >
        ...
        <LandingContainer className="space-y-4 py-4">
          ...
          {isAuthenticated ? (
            <LandingButton
              to="/dashboard"
              variant="primary"
              className="rounded-xl bg-slate-950 shadow-lg shadow-slate-900/20 hover:bg-slate-800"
            >
              <LayoutDashboard className="h-4 w-4" />
              Go to Dashboard
            </LandingButton>

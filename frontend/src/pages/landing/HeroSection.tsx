        ...
        <div className="mx-auto max-w-3xl text-center lg:mx-0 lg:text-left">
          ...
          {isAuthenticated ? (
            <p className="mt-5 text-sm font-semibold text-slate-700">
              Welcome back{user?.name ? `, ${user.name}` : ''}! Continue managing your inventory.
            </p>
          ) : null}
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
            {isAuthenticated ? (
              <LandingButton
                to="/dashboard"
                variant="primary"
                className="h-12 rounded-xl bg-slate-950 px-6 text-base shadow-lg shadow-slate-900/20 hover:bg-slate-800"
              >

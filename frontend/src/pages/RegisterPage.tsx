...
export function RegisterPage() {
  ...
  const mutation = useMutation({
    ...
    onError: (error) => {
      ...
      if (status === 409) {
        setFormError('Email already exists : Try another Email');
        return;
      }
        ...
        {formError ? (
          <div className="rounded-md border border-red-100 bg-red-50 px-3 py-2 text-sm text-red-700 dark:border-red-400/30 dark:bg-red-400/10 dark:text-red-200">
            <div className="flex items-start gap-2">
              ...
              <div>
                {formError}
                <Link to="/contact" className="ml-1.5 font-semibold text-blue-800 underline transition hover:text-black-950 dark:text-white-300 dark:hover:text-blue-100">

...
import { Bell, Check, AlertCircle, Calendar, RefreshCw, X } from 'lucide-react';
import { Page, PageHeader, SectionCard, SectionHeader } from '../components/ui/Page';
import { LoadingState } from '../components/ui/LoadingState';
import { listNotifications, markNotificationRead, deleteNotification } from '../lib/notification-api';
        ...
        {isLoading ? (
          ...
          <div className="divide-y divide-slate-100">
            {notifications.map((n) => (
              <div
                key={n.id}
                className={`flex gap-4 p-4 transition ${n.is_read ? 'bg-white opacity-60' : 'bg-indigo-50/10'
                  }`}
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <button
                        type="button"
                        className="rounded-full bg-slate-50 p-1 text-slate-400 hover:bg-red-50 hover:text-red-600 transition-colors"

...
export function PurchaseOrderDetailPage() {
  ...
  const from = (location.state as { from?: string } | null)?.from || '/purchase-orders';
    ...
    <main className="p-5">
      <div className="mb-5">
        <button
          ...
          className="mb-3 inline-flex items-center gap-2 rounded-lg py-2 pr-3 text-sm font-semibold text-slate-600 transition hover:-translate-x-0.5 hover:bg-slate-100 hover:pl-2 hover:text-slate-950 focus:outline-none focus:ring-2 focus:ring-slate-300"
        >

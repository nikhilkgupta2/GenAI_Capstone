...
def list_notifications(
    ...
    notifications = NotificationService(db).list_notifications(
        current_user,
        limit=limit,
...
def delete_notification(
    ...
    deleted = NotificationService(db).delete_notification(current_user, notification_id)
    db.commit()
    if not deleted:
        return ApiResponse(message="Notification not found or already deleted.", data=False)
    return ApiResponse(message="Notification deleted successfully.", data=True)

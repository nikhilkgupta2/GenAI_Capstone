...
def list_support_issues(db: DbSession, current_user: SuperAdminUser):
    ...
    # Pre-defined reported issues
    reported_issues = [
        {
            "id": "issue-1",
            "company_name": "Acme Retail Co.",
            "contact_email": "admin@acmeretail.io",
            "category": "CSV Import",
            "description": "Column header mapping fails for custom warehouse export format.",
            "status": "unresolved",
        ...
        },
        {
            ...
            "contact_email": "contact@sigmoid.com",
            "category": "Onboarding",
            "description": "Warehouse creation wizard crashes when entering non-ASCII barcode formats.",
            "status": "unresolved",
    ...
    return ApiResponse(
        ...
        data={
            ...
            "summary": {
                "unresolved_count": len(reported_issues),

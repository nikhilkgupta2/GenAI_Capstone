...
TOOL_PERMISSIONS: dict[str, set[str]] = {
    ...
    "get_absolute_minimum_stock": {"products", "inventory"},
    "get_top_stock_products": {"products", "inventory"},
    "get_dashboard_metrics": {"products", "inventory", "warehouses", "suppliers", "approvals"},
    "get_support_cases": {"audit_logs"},
    "get_inventory_transactions": {"inventory_transactions"},
}
